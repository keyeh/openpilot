...
def create_ui_command(packer, steer, chime, left_line, right_line, left_lane_depart, right_lane_depart, lat_available, stock_lkas_hud, lat_active):
  values = {
    "TWO_BEEPS": chime,
    "LDA_ALERT": steer,
    ...
    "LKAS_STATUS": 2 if lat_active else 1 if lat_available else 0,
